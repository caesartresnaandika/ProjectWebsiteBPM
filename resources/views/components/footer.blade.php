<footer class="bg-gray-800 text-white py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
                <h3 class="text-xl font-bold mb-4">BPM FTI UKDW</h3>
                <p class="text-gray-300">Kabinet Phronesis Aletheia</p>
                <p class="text-gray-300 mt-2">Fakultas Teknologi Informasi</p>
                <p class="text-gray-300">Universitas Kristen Duta Wacana</p>
            </div>
            
            <div>
                <h3 class="text-xl font-bold mb-4">Kontak</h3>
                <p class="text-gray-300">Email: bpmfti@ukdw.ac.id</p>
                <p class="text-gray-300">Instagram: @bpmfti_ukdw</p>
                <p class="text-gray-300">Line: @bpmftiukdw</p>
            </div>
