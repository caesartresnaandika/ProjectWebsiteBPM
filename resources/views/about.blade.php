...
@section('content')
    ...
    <section class="bg-indigo-800 text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
            <h1 class="text-4xl md:text-6xl font-extrabold tracking-tight">TENTANG KAMI</h1>
    ...
    <main class="py-20 bg-white overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <section class="parallax-effect text-center" data-sp-speed="0.9">
            ...
            <section class="parallax-effect mt-20 pt-16 border-t border-gray-200" data-sp-speed="1.1">
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 text-center">Visi & Misi</h2>
