        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <section class="text-center">
                <div data-aos="zoom-in" data-aos-duration="700">
                    <h2 class="text-4xl md:text-4xl font-bold text-gray-900">FILOSOFI KABINET</h2>
                    <p class="mt-3 text-2xl text-indigo-700 font-semibold">PHRONESIS ALETHEIA</p>
                ...
                <div class="mt-12 max-w-4xl mx-auto text-left space-y-10">
                    
                    <div class="bg-gray-50 rounded-xl p-8 shadow-sm" data-aos="fade-right" data-aos-duration="800">
                        <h3 class="text-3xl font-semibold text-gray-900">Phronesis</h3>
                    ...
                    <div class="bg-gray-50 rounded-xl p-8 shadow-sm" data-aos="fade-left" data-aos-duration="800">
                        <h3 class="text-3xl font-semibold text-gray-900">Aletheia</h3>
                        <p class="mt-3 text-gray-600 leading-relaxed">
                    ...
                    <div class="bg-gray-50 rounded-xl p-8 shadow-sm" data-aos="fade-right" data-aos-duration="800">
                        <h3 class="text-3xl font-semibold text-gray-900">Phronesis Aletheia</h3>
                        <p class="mt-3 text-gray-600 leading-relaxed">
            ...
            <section class="mt-20 pt-16 border-t border-gray-200">
                ...
                <div class="mt-12 grid grid-cols-1 md:grid-cols-2 gap-12">
                    <div class="text-center md:text-left" data-aos="fade-right" data-aos-duration="800">
                        <h3 class="text-3xl font-semibold text-indigo-700">Visi</h3>
                        <p class="mt-4 text-2xl text-gray-700 leading-relaxed">
                    ...
                    <div class="text-center md:text-left" data-aos="fade-left" data-aos-duration="800" data-aos-delay="200">
                        <h3 class="text-3xl font-semibold text-indigo-700">Misi</h3>
                        <p class="mt-4 text-2xl text-gray-700 leading-relaxed">
